...
class HandlerBase:
    ...
    @audit_action(action_type="SHOW_LINES", params_args=["transport_type"])
    ...
    @audit_action(action_type="ASK_SEARCH_METHOD", params_args=["transport_type"])
    ...
    @audit_action(action_type="SHOW_LINE_STATIONS", params_args=["transport_type"])
    ...
    @audit_action(action_type="SHOW_MAP", params_args=["transport_type"])
